...
| DeepSeek           | API-key account, usage tracking only (no CLI)                                                                              | [DeepSeek](https://api-docs.deepseek.com/)                                                        |
| Fireworks.ai       | API-key account, usage tracking only (no CLI)                                                                              | [Fireworks](https://docs.fireworks.ai/)                                                           |

DeepSeek and Fireworks.ai are not CLI agents, so there is nothing to launch. Orca reads their usage directly from an API key you paste in **Settings → Accounts**; see [Usage & rate-limit tracking](/docs/agents/usage-tracking).
