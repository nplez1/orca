...
export function ProviderPanel({
  ...
  // Why: an allowance-only plan has no window, and still has a cached readout
  // worth showing instead of the empty-error branch.
  if (
    p.status === 'error' &&
    !p.session &&
    !p.weekly &&
  ...
  // Why: an allowance-only plan's readout must survive a refresh failure, or a
