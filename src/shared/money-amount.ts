 ...
 * stay exact: Fireworks quotes 9-decimal nanos and DeepSeek quotes plain
 * decimals, and neither survives a float round-trip.
 */
export type MoneyAmount = {
  /**
   * ISO 4217 code exactly as the provider stated it. DeepSeek can answer in
   * CNY, so consumers must never assume USD.
   */
  currencyCode: string
 ...
 * currency the provider listed (DeepSeek returns CNY for CN accounts).
 */
