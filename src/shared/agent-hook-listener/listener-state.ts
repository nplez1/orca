...
export type CopilotBackgroundWorkState = {
  ...
  /** Counterpart above, once a SubagentStart hook has identified the subagent. */
  pendingSubagentLifecycleCount: number
  /** A Stop arrived with work still outstanding, so settling the last item ends the turn. */
  leadStopped: boolean
}
