...
describe('OrcaRuntimeService', () => {
  ...
  it.each([
    { platform: 'win32' as const, expected: 'orca-np.cmd claude-teams' },
    { platform: 'linux' as const, expected: 'orca-np claude-teams' },
    { platform: 'darwin' as const, expected: 'orca-np claude-teams' }
  ])(
